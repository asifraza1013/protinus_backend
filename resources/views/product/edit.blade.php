            ...
            <div class="col-lg-12">
                <div class="card">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_name" id="" class="form-control">
                                                ...
                                                <option value="{{ $item->_id }}"
                                                    {{ ($product->userName->userName == $item->userName) ? 'selected' : ''}}
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Product Name"
                                                ...
                                                aria-describedby="basic-addon1" value="{{ $product->productName }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Product Price"
                                                aria-label="Username" name="price" aria-describedby="basic-addon1" value="{{ $product->price }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="sub_category" id="sub-cate" class="form-control">
                                                ...
                                                <option value="{{ $item->_id }}"
                                                {{ ($product->subCategory->_id == $item->_id) ? 'selected' : '' }}
                                                >{{ $item->name }} ({{
                                                    $item->productType
                                                    }})</option>
                                                @endforeach
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Product ID"
                                                ...
                                                readonly id="product_id" value="{{ $product->productId }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                                        ...
                                                        <tr class="template_row">
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control attribute" id="attribute" name=""
                                                                    value="{{ $item[0] }}" placeholder="Attribute"/>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="long form-control quantity" id="quantity" name=""
                                                                    value="{{ $item[1] }}" placeholder="Quantity"/>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control sku" id="SKU" name="" value="{{ $item[2] }}" placeholder="SKU"/>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                        @else
                    ...
                    <div class="col-2 text-left mt-lg-5 mt-3 mb-lg-3">
                        <button type="button" class="btn btn-block btn-lg btn-primary text-white add-product" title="">Upate Product</button>
                    </div>
                    </form>
                </div>
            </div>

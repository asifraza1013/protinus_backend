...
<head>
<title>Admin Login | Protinus</title>
<meta charset="utf-8">
        ...
        <div class="auth_div">
            <div class="card">
                <div class="auth_brand">
                    <a class="navbar-brand" href="{{ route('login') }}"><i class="fa fa-cube font-25"></i> Protinus</a>
                </div>
                <div class="body">
                    <p class="lead">Admin Login</p>
                    @include('msg.flash_message')
                    <form class="form-auth-small m-t-20" action="{{ route('admin.login.proceed') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="signin-email" class="control-label sr-only">Email</label>
                            <input type="email" class="form-control round" id="signin-email" value="" name="email" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <label for="signin-password" class="control-label sr-only">Password</label>
                            <input type="password" class="form-control round" id="signin-password" value="" name="password" placeholder="Password">
                        </div>

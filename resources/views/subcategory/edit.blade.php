    ...
    <div class="container">
        <div class="row clearfix">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <form action="{{ route('subcategory.update', $subcate->_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row clearfix">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="name" aria-describedby="basic-addon1" value="{{ $subcate->name }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Product Type" aria-label="Username" name="prodcut_type" aria-describedby="basic-addon1" value="{{ $subcate->productType }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select name="status" id="" class="form-control">
                                               ...
                                               @foreach (config('constants.user_status') as $key=>$item)
                                                    <option value="{{ $key }}" {{ ($subcate->status == $key) ? 'selected' : ''  }}>{{ $item }}</option>
                                               @endforeach
                                           </select>
                                        </div>
                                    </div>

                                ...
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Bank Name" aria-label="Username" name="bank_name" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Account Number" aria-label="Username" name="account_number" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                </div>
                            </div>

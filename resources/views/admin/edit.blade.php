                                ...
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Username" aria-label="Username" name="user_name" aria-describedby="basic-addon1" value="{{ $admin->userName }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="email address" aria-label="Username" name="email" aria-describedby="basic-addon1" value="{{ $admin->email }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select name="status" id="" class="form-control">
                                               ...
                                               @foreach (config('constants.user_status') as $key=>$item)
                                                    <option value="{{ $key }}" {{ ($key == $admin->status) ? 'selected' : ''}}>{{ $item }}</option>
                                               @endforeach
                                           </select>
                                        </div>
                                    </div>
